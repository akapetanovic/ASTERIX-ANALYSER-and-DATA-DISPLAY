...
namespace AsterixDisplayAnalyser
{
    ...
    class SEP_Tool_Calculator
    {
        ...
        private int LookAheadTimeInSeconds;
        ...
        public SEP_Tool_Calculator(GlobalPosition Track_1_Position, GlobalPosition Track_2_Position,
                        ...
                        int LookAheadTimeInSec)
        {
            OutData ReturnData = new OutData();
            ...
            LookAheadTimeInSeconds = LookAheadTimeInSec;
        }
        ...
        public OutData GetResult()
        {
            ...
            ReturnData.StartPosition.X = MarkerPositionLocal.X;
            ReturnData.StartPosition.Y = MarkerPositionLocal.Y;

            // Calculate new position X seconds ahead for track 2
            Range = (Track_2_SPD / 60) * 1;
            ...
            ReturnData.EndPosition.X = MarkerPositionLocal.X;
            ReturnData.EndPosition.Y = MarkerPositionLocal.Y;
            ...
            if (distance1 > distance2)
            {
                ...
                ReturnData.MinDistance = distance2;
            }
